...
export enum ASTKinds {
    ...
    smallNonFinalSigma = "smallNonFinalSigma",
...
export type smallSigma_1 = smallNonFinalSigma;
export type smallSigma_2 = smallSingleSigma;
export class smallNonFinalSigma {
    public kind: ASTKinds.smallNonFinalSigma = ASTKinds.smallNonFinalSigma;
...
export class Parser {
    ...
    public matchsmallSigma_1($$dpth: number, $$cr?: ErrorTracker): Nullable<smallSigma_1> {
        return this.matchsmallNonFinalSigma($$dpth + 1, $$cr);
    }
    public matchsmallSigma_2($$dpth: number, $$cr?: ErrorTracker): Nullable<smallSigma_2> {
        return this.matchsmallSingleSigma($$dpth + 1, $$cr);
    }
    public matchsmallNonFinalSigma($$dpth: number, $$cr?: ErrorTracker): Nullable<smallNonFinalSigma> {
        return this.run<smallNonFinalSigma>($$dpth,
            () => {
                let $scope$child: Nullable<alphabet>;
                let $$res: Nullable<smallNonFinalSigma> = null;
                if (true
                    && this.regexAccept(String.raw`(?:s)`, "", $$dpth + 1, $$cr) !== null
                    && ($scope$child = this.matchalphabet($$dpth + 1, $$cr)) !== null
                ) {
                    $$res = new smallNonFinalSigma($scope$child);
                }
                return $$res;
            });
    }
